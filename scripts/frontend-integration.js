 ...
 * This file demonstrates how to integrate Shiftforge with a web frontend
 */

// For React/Vue/Angular applications
export class ShiftforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ShiftforgeClient(provider, contractAddress);
